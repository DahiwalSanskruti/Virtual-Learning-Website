	...
	<nav class="navbar navbar-inverse navbar-fixed-top">
		<div class="container">
			<div class="navbar-header">
				...
				<h1 style="color: white;margin-top: 10px;" id="myhead">Virtual Learning</h1>
			</div>
					...
					<div class="col-md-12">
						<div id="team-memebers" class="owl-carousel owl-theme">
							<div class="team-member text-center">
								<img src="img/sanku1.png" class="img-responsive">
								<div class="team-member-info text-center">
									<h4 class="team-member-name">Sanskriti Dahiwal</h4>
							...
							<div class="team-member text-center">
								<img src="img/vaishali.png" class="img-responsive">
								<div class="team-member-info text-center">
									<h4 class="team-member-name">Vaishali Bhagat</h4>
									<h4 class="team-member-designation"></h4>
																	</div>
							</div>
							...
							<div class="team-member text-center">
								<img src="img/kedar.png" class="img-responsive">
								<div class="team-member-info text-center">
									<h4 class="team-member-name">Kedar Gughane</h4>
									<h4 class="team-member-designation"></h4>
							...
							<div class="team-member text-center">
								<img src="img/rohit.png" class="img-responsive">
								<div class="team-member-info text-center">
									<h4 class="team-member-name">Rohit Shukla</h4>
									<h4 class="team-member-designation"></h4>
							...
							<div class="team-member text-center">
								<img src="img/keyur.png" class="img-responsive">
								<div class="team-member-info text-center">
									<h4 class="team-member-name">Keyur Ughade</h4>
									<h4 class="team-member-designation"></h4>
							...
							<?php } ?>
								...
								<div class="panel panel-default">
									...
									<div id="collapseTwo" class="panel-collapse collapse" aria-labelledby="headingTwo">
										<div class="panel-body">
											<p>
												Virtual Learning is an online E-learning website <br>
